...
private let A1_AVATAR_SIZE = 200 + A1_BORDER_WIDTH
let A2_BORDER_WIDTH : CGFloat = 3
private let A2_AVATAR_SIZE = 90 + A2_BORDER_WIDTH
let A3_BORDER_WIDTH : CGFloat = 2
private let A3_AVATAR_SIZE = 50 + A3_BORDER_WIDTH
let A4_BORDER_WIDTH : CGFloat = 2
private let A4_AVATAR_SIZE = 40 + A4_BORDER_WIDTH
