...
@7174
Scenario: Access Confirm Mug screen through Camera View screen
...
@7456
Scenario: Access Confirm Mug screen through Compose screen
...
Scenario: Rejecting a picture
  ...
  And I go to "Confirm Mug" screen
  When I touch "X" icon
...
@7456
Scenario: Open Confirm Mug screen when there is a record
  Given I am on the "Compose" screen
  And I have a "<record>" recorded
  When I go to "Confirm Mug" screen
...
Scenario: Touching the frame when the record is playing
  Given I am on the "Confirm Mug" screen
...
@7456
Scenario: Open Confirm Mug screen when there is not a record
  Given I am on the "Compose" screen
