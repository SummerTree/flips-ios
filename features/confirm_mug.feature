...
@7174 @ok
Scenario: Access Confirm Flips screen through Camera View screen
  Given I am on the "Camera View" screen
  When I touch "Yellow circle" icon
  Then I should see "Confirm Flips" screen
  And I should see a white background mask instead of dark opaque around the border

@7456 @ok
Scenario: Access Confirm Flips screen through Compose screen
