Feature: Preview screen
  As a user
  I want to see a preview of the flips that I'm creating
  So, If I don't like something, I can change it before send it to my friends

@7457 @Nok
Scenario: Accessing Preview screen when the last word is selected and I select a picture on My Flips/Stock Flips option
  Given I am on the "Compose" screen
  And The last word of the phrase is selected
  When I select a picture on My Flips/Stock Flips option
...
@7457 @Nok
Scenario: Touching Preview button when I have available flips to select
  Given I am on the "Compose" screen
  And I am seeing My Flips/Stock Flips option
  When I touch "Preview" button
  Then I should see "Preview" screen

@7457 @ok
Scenario: Touching Preview button when I don't have available flips to select
  Given I am on the "Compose" screen
...
@7457 @Nok @IcouldntTestConfirmScreen
